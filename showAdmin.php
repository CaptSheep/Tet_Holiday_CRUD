...
<table border="1">
    ...
    <?php foreach ($accounts as $key => $account): ?>
        <tr>
            ...
            <td style="color: white"><a  onclick="return confirm('A ziu sua o bao zit')" href="deleteAdmin.php?id=<?php echo $key ?>"  >DELETE ADMIN</a></td>
            <td style="color: white"><a href="editAdmin.php?id=<?php echo $key ?>">EDIT ADMIN</a></td>
            <td style="color: white"><a href="detailAdmin.php?id=<?php echo $key ?>">DETAIL</a></td>
        </tr>
    <?php endforeach; ?>
